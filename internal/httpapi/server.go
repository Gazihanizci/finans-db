...
func (s *Server) handleLatest(w http.ResponseWriter, r *http.Request) {
	...
	resp := map[string]interface{}{
		...
		"data": map[string]interface{}{
			...
			"JPYTRY":         map[string]float64{"value": snap.JPYTRY},
			"CHFTRY":         map[string]float64{"value": snap.CHFTRY},
			"CADTRY":         map[string]float64{"value": snap.CADTRY},
			"AUDTRY":         map[string]float64{"value": snap.AUDTRY},
			"NZDTRY":         map[string]float64{"value": snap.NZDTRY},
			"SEKTRY":         map[string]float64{"value": snap.SEKTRY},
			"NOKTRY":         map[string]float64{"value": snap.NOKTRY},
			"DKKTRY":         map[string]float64{"value": snap.DKKTRY},
			"PLNTRY":         map[string]float64{"value": snap.PLNTRY},
